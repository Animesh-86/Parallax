...
export function ProfileSkeleton() {
    return (
        <div className="min-h-screen bg-[#09090B] text-white relative overflow-hidden flex pt-16">
            {/* Sidebar Skeleton */}
            <aside className="w-64 bg-[#09090B] border-r border-white/5 p-4 fixed left-0 top-16 bottom-0 z-40">
                ...
                <div className="bg-[#09090B] border border-white/5 rounded-3xl overflow-hidden">
                    ...
                    <div className="px-8 pb-8">
                        <div className="flex items-end gap-6 -mt-16 mb-6">
                            <Skeleton className="w-32 h-32 rounded-2xl border-4 border-[#09090B] bg-white/10" />
