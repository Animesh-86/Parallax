...
const MASTER_FEATURES = [
    {
        ...
        desc: "Monaco-powered editor with live multi-cursor editing, OT-based conflict resolution, and sub-millisecond sync latency.",
        size: "hero",
    ...
    },
    {
        ...
        title: "True PTY Terminals",
        desc: "Direct WebSocket attachment to Docker containers for full interactive shell sessions (vim, top, apt-get).",
        size: "medium",
    ...
    },
    {
        ...
        desc: "Commit, branch, and push directly from the UI. Full visual Git history and staging tools.",
        size: "medium",
        gridClass: "lg:col-span-4 lg:row-span-1",
    ...
    },
    {
        ...
        desc: "Language Servers provide auto-complete, diagnostics, and hover tools for Java, Python, TS, and C/C++.",
        size: "standard",
        gridClass: "lg:col-span-4 lg:row-span-1"
    },
    {
        ...
        desc: "Peer-to-peer media streams with STOMP signaling integrated directly into the workspace.",
        size: "standard",
        gridClass: "lg:col-span-4 lg:row-span-1"
    },
    {
        ...
        statusTone: "live",
        category: "Execution",
        title: "Full-Stack Previews",
        desc: "Spin up React or Next.js servers in your container and view them live in the browser preview panel.",
        size: "standard",
        gridClass: "lg:col-span-4 lg:row-span-1"
    },
    {
        ...
        desc: "Secure JWT login via GitHub, Google, or standard credentials.",
        size: "standard",
    ...
    },
    {
        ...
        title: "RBAC Controls",
        desc: "Hierarchical permissions across Teams, Projects, and individual sessions.",
        size: "standard",
        gridClass: "lg:col-span-3 lg:row-span-1"
    },
    {
        ...
        category: "Communication",
        title: "Unified Chat",
        desc: "Persistent Team, Project, and Direct messaging with rich attachments.",
        size: "standard",
        gridClass: "lg:col-span-3 lg:row-span-1"
    },
    {
        ...
        desc: "Bidirectional sync between the browser tree, database, and Docker volume.",
        size: "standard",
        gridClass: "lg:col-span-3 lg:row-span-1"
    }
];
