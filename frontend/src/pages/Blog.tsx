                ...
                <div className="max-w-4xl mx-auto px-6 lg:px-8">
                    ...
                    <div className="space-y-4">
                        {posts.map((post, index) => (
                            <motion.article
                                key={index}
                                className="group p-6 rounded-2xl bg-white/[0.04] border border-white/10 hover:bg-white/[0.07] hover:border-[#D4AF37]/20 transition-all duration-300 cursor-pointer"
                                initial={{ opacity: 0, y: 20 }}
                            ...
                            >
                                ...
                                <h2 className="text-xl font-medium text-white mb-2 group-hover:text-[#D4AF37] transition-colors">
                                    {post.title}
                                </h2>
                                <p className="text-sm text-[#A1A1AA] leading-relaxed mb-3">
                                    {post.excerpt}
                                </p>
                                <span className="inline-flex items-center gap-1 text-sm text-[#D4AF37] group-hover:gap-2 transition-all">
