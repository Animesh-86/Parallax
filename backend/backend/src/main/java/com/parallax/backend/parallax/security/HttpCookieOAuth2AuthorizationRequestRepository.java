...
public class HttpCookieOAuth2AuthorizationRequestRepository
    ...
    public void saveAuthorizationRequest(
        ...
        // Use explicit Set-Cookie header to include SameSite attribute (Lax for local dev).
        // Using Cookie API does not allow setting SameSite directly on all JVMs.
        addCookieHeader(response, cookie, "Lax");
    }
    ...
    private void removeAuthorizationRequestCookies(HttpServletResponse res) {
        // Expire the cookie and include SameSite to match the saved cookie attributes.
    ...
    private void addCookieHeader(HttpServletResponse res, Cookie cookie, String sameSite) {
        StringBuilder sb = new StringBuilder();
