...
public class MergeRequestResponse {
    ...
    public static MergeRequestResponse from(MergeRequest mr) {
        return MergeRequestResponse.builder()
                ...
                .sourceBranchId(UUID.nameUUIDFromBytes(mr.getSourceBranch().getBytes()))
                .sourceBranchName(mr.getSourceBranch())
                .targetBranchId(UUID.nameUUIDFromBytes(mr.getTargetBranch().getBytes()))
                .targetBranchName(mr.getTargetBranch())
