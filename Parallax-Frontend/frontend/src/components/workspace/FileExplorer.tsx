...
export function FileExplorer({
  ...
  const renderCreationInput = (depth: number) => {
    ...
    return (
      ...
      >
        ...
        <input
          autoFocus
          className="bg-[#162032] text-white text-xs border border-[#64748B]/50 rounded px-1.5 py-0.5 outline-none min-w-[120px] shadow-lg shadow-[#64748B]/10"
          value={newItemName}
      ...
      return (
        <div key={node.path}>
          ...
          >
            ...
            <FolderIcon className={`w-3.5 h-3.5 ${isSelected ? "text-[#94A3B8]" : "text-[#fbbf24]"}`} />
  ...
  return (
    <div className="w-full h-full bg-[#060910] border-r border-white/5 flex flex-col">
      {/* Header */}
