                ...
                <div className="max-w-6xl mx-auto px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        {practices.map((item, index) => (
                            <motion.div
                                key={index}
                                className="group p-6 rounded-2xl bg-white/[0.04] border border-white/10 hover:bg-white/[0.07] hover:border-[#2DD4BF]/20 transition-all duration-300"
                                initial={{ opacity: 0, y: 20 }}
                                whileInView={{ opacity: 1, y: 0 }}
                                viewport={{ once: true }}
                                transition={{ delay: index * 0.08, duration: 0.5 }}
                            >
                                <div className="w-10 h-10 rounded-xl bg-[#2DD4BF]/10 border border-[#2DD4BF]/20 flex items-center justify-center mb-4 group-hover:bg-[#2DD4BF]/20 transition-colors">
                    ...
                    >
                        <p className="text-[#CBD5E1]">
                            ...
                            <Link to="/contact" className="text-[#38BDF8] hover:underline">contact page</Link>.
